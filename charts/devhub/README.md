...
![Version: 2.25.2](https://img.shields.io/badge/Version-2.25.2-informational?style=flag) ![AppVersion: v2.25.2](https://img.shields.io/badge/AppVersion-v2.25.2-informational?style=flag)
...
| queryParser.image.tag | string | `"v2.3.1"` |  |
| replicaCount | int | `1` |  |
