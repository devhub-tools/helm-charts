...
![Version: 2.0.4](https://img.shields.io/badge/Version-2.0.4-informational?style=flag) ![AppVersion: v1.3.29](https://img.shields.io/badge/AppVersion-v1.3.29-informational?style=flag)
...
1. Create another helm installation and set the agent flag
    ...
    helm install devhub-agent devhub/devhub \
      ...
      --set devhub.agentConfig.name=agent-config.json \
